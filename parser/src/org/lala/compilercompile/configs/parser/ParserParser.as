...
;_inputTable = 
{"<$>":1,"grammar_rule_begin":2,"grammar_dec_class":3,"grammar_id":4,"grammar_dec_lexer_name":5,"grammar_dec_package":6,"grammar_dec_import":7,"grammar_code":8,"grammar_dec_initial":9,"grammar_dec_field":10,"grammar_dec_start":11,"grammar_string":12,"grammar_dec_left":13,"grammar_dec_right":14,"grammar_dec_nonassoc":15,":":16,";":17,"|":18,"grammar_dec_prec":19,"{":20,"}":21,"grammar_action_body":22,"lex_begin":23,"rule_start":24,"lex_end":25,"dec_package":26,"name":27,"dec_initial":28,"lex_code":29,"dec_import":30,"dec_class":31,"dec_inc":32,"dec_exc":33,"dec_field":34,"<":35,">":36,"pattern":37,"action":38}
;
        }
        
        public function parse(lexer:ParserLexer):*
        {
...
case 0x1:
                ...
                if(_outputStack[_outputStack.length - 3].start == null && _outputStack[_outputStack.length - 1].length > 0)
                {
                    _outputStack[_outputStack.length - 3].start = _outputStack[_outputStack.length - 1][0].head;
                }
...
case 0x2C:
            ...
            _result = {rules:_outputStack[_outputStack.length - 2], states:{inclusive:[],exclusive:[]}, 
